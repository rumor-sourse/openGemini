...
func (e *Exporter) NewBar() *mpb.Bar {
	...
	bar := progress.New(int64(e.filesTotalCount),
...
// checkStringNotInSlice checks if a string is not in a slice
...
// getFieldNameIndex returns the index of a field in a slice
